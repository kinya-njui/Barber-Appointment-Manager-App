...
function BlogCard({ id, profileImage, username, blogTitle, blogSynopsis, blogBody, blogImage, timestamp }) {
...
function AllBlogs() {
    ...
    const {data, isLoading, isError, error} = useQuery({
      queryKey: ['allBlogs'],
      queryFn: async () => {
        const response = await fetch(`${apiUrl}/all-blogs`, {credentials: "include"});
